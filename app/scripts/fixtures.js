...
var albumHrithik = {
     ...
     songs: [
         { name: 'Lakshya 1', length: '1:01' },
         { name: 'Lakshya 2', length: '5:01' },
         { name: 'Lakshya 3', length: '3:21'},
         { name: 'Lakshya 4', length: '3:14' },
         { name: 'Lakshya 5', length: '5:01' },
         { name: 'Lakshya 6', length: '3:21'},
         { name: 'Lakshya 7', length: '3:14' },
         { name: 'Lakshya 8', length: '2:15'}
     ]
 };